<div>
        <div class="mb-3">
            <label for="parent" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$label}}</label>
        ...
        <div class="mb-3">
            <label for="v" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{$label}}</label>
